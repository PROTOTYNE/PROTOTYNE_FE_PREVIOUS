...
import UsageList from '@/entities/element/myTicket/UsageList';
...
const App: React.FC = () => {
  ...
  const [transactions, setTransactions] = useState([
    { date: '2024-07-22', title: '프로토타인', detail: '구매', amount: '티켓 5개' },
    { date: '2024-07-01', title: '프로토타인', detail: '7월 무료 제공 티켓', amount: '티켓 10개' },
    { date: '2024-06-12', title: '개매운떡볶이', detail: '후기 미작성 패널티-티켓 차감', amount: '-티켓 6개', isNegative: true },
    { date: '2024-06-01', title: '프로토타인', detail: '6월 무료 제공 티켓', amount: '티켓 10개' },
    { date: '2024-05-12', title: '마라탕후루어쩌구', detail: '우수 체험자', amount: '티켓 3개' }
  ]);

  const [usages] = useState([
    { date: '2024-07-22', title: '신청한 시제품 제목', company: '기업명', amount: '티켓 5개' },
    { date: '2024-07-15', title: '신청한 시제품 제목', company: '기업명', amount: '티켓 5개' },
    { date: '2024-07-10', title: '신청한 시제품 제목', company: '기업명', amount: '티켓 5개' },
  ]);
